...
do
    ...
    do
        echo "./build/fast_skip_list_host -c -t -d -f /scratch/pim_tree_data/init.insorted /scratch/ycsb/test_100000000_${type}_${zipf_factor}.in > results9/result_${zipf_factor}_${type}.txt"
