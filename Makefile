...
HOST_TARGET_UPMEM := ${BUILDDIR}/pim_tree_host_upmem
...
${HOST_TARGET}: ${HOST_SOURCES} ${HOST_INCLUDES} ${COMMON_INCLUDES} ${COMMON_INCLUDE_SOURCES} ${CONF}
	$(CC) -o $@ ${HOST_SOURCES} ${HOST_FLAGS} -DSHADOW_SUBTREE=1 -DDIRECT_INTERFACE

${HOST_TARGET_UPMEM}: ${HOST_SOURCES} ${HOST_INCLUDES} ${COMMON_INCLUDES} ${COMMON_INCLUDE_SOURCES} ${CONF}
